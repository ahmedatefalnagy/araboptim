...
@php
    ...
    $buyerAddress = $isPurchase ? \App\Models\Setting::get('company_address', 'الرياض - الملز - شارع الهواري') : ($invoice['contact']['address'] ?? '---');
@endphp
        ...
        <td width="33%">
            <table class="meta-inner-table">
                ...
                <tr>
                    ...
                    <td class="meta-value">
                        {{ $invoice['due_date'] ? date('d-m-Y', strtotime($invoice['due_date'])) : date('d-m-Y', strtotime($invoice['invoice_date'])) }}
                    </td>
                </tr>
            </table>
        </td>
