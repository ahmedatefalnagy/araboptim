...
export default function Create({ auth, type, contacts, items, warehouses, paymentAccounts = [], costCenters = [], parentDocument = null, fiscalYears = [], selectedFiscalYearId = null }) {
