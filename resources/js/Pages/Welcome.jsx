            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex flex-col items-center gap-6">
                        <img src="/logo.png?v=2" alt="Arab Optim Logo" className="h-32 w-auto animate-bounce-slow" />
                        <h1 className="text-6xl font-black text-slate-900 tracking-tighter italic">عرب أوبتيم</h1>
                        <p className="text-xl font-bold text-slate-500 uppercase tracking-[0.3em]">Arab Optim Management System</p>
                    </div>
